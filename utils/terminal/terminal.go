...
func (t *Terminal) LoadHistory() (err error) {
	fd, err := os.Open(t.historyFile)
	if err != nil {
		fmt.Printf("failed to history file %s\n", t.historyFile)
		return err
	}
...
// SetHistoryFile with filename and open it
func (t *Terminal) SetHistoryFile(file string) (err error) {
	t.historyFile = file
	err = t.OpenHistoryFile()
	return err
}

// OpenHistoryFile and save file fd
func (t *Terminal) OpenHistoryFile() (err error) {
	if t.historyFd == nil {
		t.historyFd, err = os.OpenFile(t.historyFile, os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0644)
		if err != nil {
...
// SaveHistory to file
func (t *Terminal) SaveHistory(line []byte) {
	if t.historyFd == nil {
		fmt.Println("historyFd is nil")
		return
	}

	_, err := t.historyFd.Write(append(line, '\n'))
	if err != nil {
		fmt.Println("failed to save history")
		return
	}
...
// Enable terminal
func (t *Terminal) Enable() (err error) {
	if t.enable {
		return nil
	}
...
// Disable terminal
func (t *Terminal) Disable() (err error) {
